...
void GLManipulator::setupTexture(){
	...
	int width, height;
	unsigned char* image = SOIL_load_image("C:/martinka/libs/cone_texture.png", &width, &height, 0, SOIL_LOAD_RGB);
	...
	unsigned char* image2 = SOIL_load_image("C:/martinka/libs/textura.png", &width, &height, 0, SOIL_LOAD_RGB);
